                      ...
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          if (!id) {
                            ...
                            url = 'http://127.0.0.1:8080/api/v1/users/'.concat(
                              id
                            );
                          }
                          ...
                          url = 'manageUsers?'
                            .concat(
                              !filter.page || filter.page == '1'
                                ? ''
                                : '&page='.concat(filter.page)
                            )
                            .concat(
                              !filter.sex || filter.sex == '1'
                                ? ''
                                : '&sex='.concat(filter.sex)
                            )
                            .concat(
                              filter.role ? '' : '&role='.concat(filter.role)
                            )
                            .concat(
                              !filter.teacher || filter.teacher == '1'
                                ? ''
                                : '&teacher='.concat(filter.teacher)
                            )
                            .concat(
                              !filter.birthYear || filter.birthYear == '1'
                                ? ''
                                : '&birthYear='.concat(filter.birthYear)
                            )
                            .concat(
                              !filter.name || filter.name == '1'
                                ? ''
                                : '&search='.concat(filter.name)
                            );
                          location.assign(url);
                        } catch (err) {
                          (0, _alerts.showAlert)(
                  ...
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'GET',
                          url: 'http://127.0.0.1:8080/api/v1/races/stats/'
                            .concat(distance, '/')
                            .concat(name, '/')
                            .concat(compareBy, '/')
                            .concat(student)
                      ...
                      case 10:
                        ...
                        labels = res.data.data.racesPersoByDate.map(function(
                          el
                        ) {
                          return ''
                            .concat(
                              new Date(Date.parse(el.races.date)).getUTCDay(),
                              '/'
                            )
                            .concat(
                              new Date(Date.parse(el.races.date)).getMonth() +
                                1,
                              '/'
                            )
                            .concat(
                              new Date(Date.parse(el.races.date)).getFullYear()
                            );
                        }); // -- Data --
                        ...
                        avg = ''
                          .concat(
                            Math.trunc(
                              res.data.data.statsPerso[0].avgRaking / 60
                            ),
                            "'"
                          )
                          .concat(
                        ...
                        med = ''
                          .concat(
                            Math.trunc(res.data.data.MQ.mediane / 60),
                            "'"
                          )
                          .concat(
                            (
                        ...
                        fstQ = ''
                          .concat(
                            Math.trunc(res.data.data.MQ.fstQuartile / 60),
                            "'"
                          )
                          .concat(
                            (
                              Math.round(
                                (res.data.data.MQ.fstQuartile -
                                  Math.trunc(
                                    res.data.data.MQ.fstQuartile / 60
                                  ) *
                                    60) *
                                  100
                              ) / 100
                        ...
                        trdQ = ''
                          .concat(
                            Math.trunc(res.data.data.MQ.trdQuartile / 60),
                            "'"
                          )
                          .concat(
                            (
                              Math.round(
                                (res.data.data.MQ.trdQuartile -
                                  Math.trunc(
                                    res.data.data.MQ.trdQuartile / 60
                                  ) *
                                    60) *
                                  100
                              ) / 100
                        ...
                        max = ''
                          .concat(
                            Math.trunc(
                              res.data.data.statsPerso[0].minRaking / 60
                            ),
                            "'"
                          )
                          .concat(
                        ...
                        min = ''
                          .concat(
                            Math.trunc(
                              res.data.data.statsPerso[0].maxRaking / 60
                            ),
                            "'"
                          )
                          .concat(
                        ...
                        document.getElementById(
                          ...
                          .concat(res.data.data.race.distance, ' ')
                          .concat(res.data.data.race.name);
                        document.getElementById(
                          'nbRatings'
                        ).textContent = 'Nombre de course:  '.concat(
                          res.data.data.statsPerso[0].numRankings
                        );
                        nameRace;
                        document.getElementById(
                          'avg'
                        ).textContent = 'Temps moyen: '.concat(avg);
                        document.getElementById(
                          'med'
                        ).textContent = 'M\xE9diane:  '.concat(med);
                        document.getElementById(
                          'fstQ'
                        ).textContent = '1er Quartiles:  '.concat(fstQ);
                        document.getElementById(
                          'trdQ'
                        ).textContent = '3\xE8me Quartiles:  '.concat(trdQ);
                        document.getElementById(
                          'max'
                        ).textContent = 'Reccord:  '.concat(max);
                        document.getElementById(
                          'min'
                        ).textContent = 'Minimum:  '.concat(min); // -- Label --

                        labelsCompare = res.data.data.statsByComapareByDates.map(
                          function(el) {
                            return el._id;
                          }
                        ); // -- Data --

                        dataCompare = res.data.data.statsByComapareByDates.map(
                          function(el) {
                            return -el.avgRaking;
                          }
                        );
                        ...
                        dataCompareMax = [];
                        dataCompareMin = [];
                        res.data.data.statsPersoByComapareByDates.forEach(
                          function(el) {
                            dataPerso.push({
                              x: el._id,
                              y: -el.avgRaking
                        ...
                        res.data.data.statsByComapareByDates.forEach(function(
                          el
                        ) {
                          dataCompareMax.push({
                            x: el._id,
                        ...
                        try {
                          url = 'historical?'
                            ...
                            .concat(
                              filter.name || filter.name == '1'
                                ? ''
                                : '&races.race.name='.concat(filter.name)
                            )
                            .concat(
                              !filter.size || filter.size == '1'
                                ? ''
                                : '&races.size='.concat(filter.size)
                            )
                            .concat(
                              !filter.season || filter.season == '1'
                                ? ''
                                : '&season='.concat(filter.season)
                            );
                          location.assign(url);
                        } catch (err) {
                          (0, _alerts.showAlert)(
    ...
    'index.js': [
      function(require, module, exports) {
        ...
        if (userFilterForm) {
          ...
          userFilterForm.addEventListener(
            'submit',
            /*#__PURE__*/
            (function() {
              var _ref3 = _asyncToGenerator(
        ...
        if (studentsFilterForm) {
          ...
          var teacher = new URL(window.location).pathname
            .split('/')[2]
            .split('?')[0]; // Buttons
          ...
          studentsFilterForm.addEventListener(
            'submit',
            /*#__PURE__*/
            (function() {
      ...
      },
      {
        ...
        './getUsers': 'getUsers.js',
        './chart.js': 'chart.js',
        './getRaces': 'getRaces.js'
      }
    ],
