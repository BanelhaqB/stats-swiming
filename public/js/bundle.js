...
exports.update_group = exports.deleteUser = exports.updateSettings = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            id = new URL(window.location).pathname.split('/')[2];
            console.log(id);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Utilisateur supprimé!');
              window.setTimeout(function () {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(group, id) {
    var url, data, res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            // console.log(res.data.status);
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Modification effectuée');
            }
  ...
  return function update_group(_x3, _x4) {
    return _ref3.apply(this, arguments);
  };
}();

exports.update_group = update_group;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"getUsers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getStudents = exports.getUsers = void 0;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            try {
              url = "manageUsers?".concat(!filter.page || filter.page == '1' ? '' : "&page=".concat(filter.page)).concat(!filter.role || filter.role == '1' ? '' : "&role=".concat(filter.role)).concat(!filter.sex || filter.sex == '1' ? '' : "&sex=".concat(filter.sex)).concat(filter.role ? '' : "&role=".concat(filter.role)).concat(!filter.teacher || filter.teacher == '1' ? '' : "&teacher=".concat(filter.teacher)).concat(!filter.birthYear || filter.birthYear == '1' ? '' : "&birthYear=".concat(filter.birthYear)).concat(!filter.name || filter.name == '1' ? '' : "&search=".concat(filter.name));
              location.assign(url);
            } catch (err) {
...
function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            try {
              url = "/students".concat(!filter.teacher || filter.teacher == '1' ? '' : "/".concat(filter.teacher), "?").concat(!filter.page || filter.page == '1' ? '' : "&page=".concat(filter.page)).concat(!filter.sex || filter.sex == '1' ? '' : "&sex=".concat(filter.sex)).concat(!filter.group || filter.group == '' ? '' : "&group=".concat(filter.group)).concat(!filter.birthYear || filter.birthYear == '1' ? '' : "&birthYear=".concat(filter.birthYear)).concat(!filter.name || filter.name == '1' ? '' : "&search=".concat(filter.name));
              location.assign(url);
            } catch (err) {
              (0, _alerts.showAlert)('error', err.response.data.message);
            }
  ...
  return function getStudents(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.getStudents = getStudents;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"chart.js":[function(require,module,exports) {
"use strict";
...
function sectomin2(time) {
  var min = Math.floor(-time / 60).toString(10);
  var sec = (Math.round(100 * (-time % 60)) / 100).toString(10).split('.')[0].length == 2 ? (Math.round(100 * (-time % 60)) / 100).toString(10).split('.')[0] : '0'.concat('', (Math.round(100 * (-time % 60)) / 100).toString(10).split('.')[0]);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 19:
            ...
            avg = "".concat(Math.trunc(res.data.data.statsPerso[0].avgRaking / 60), "'").concat((Math.round((res.data.data.statsPerso[0].avgRaking - Math.trunc(res.data.data.statsPerso[0].avgRaking / 60) * 60) * 100) / 100).toString().split('.')[0], "\"").concat((Math.round((res.data.data.statsPerso[0].avgRaking - Math.trunc(res.data.data.statsPerso[0].avgRaking / 60) * 60) * 100) / 100).toString().split('.')[1]);
            med = "".concat(Math.trunc(res.data.data.MQ.mediane / 60), "'").concat((Math.round((res.data.data.MQ.mediane - Math.trunc(res.data.data.MQ.mediane / 60) * 60) * 100) / 100).toString().split('.')[0], "\"").concat((Math.round((res.data.data.MQ.mediane - Math.trunc(res.data.data.MQ.mediane / 60) * 60) * 100) / 100).toString().split('.')[1]);
            ...
            nameRace;
            document.getElementById('avg').textContent = "Temps moyen: ".concat(avg);
            document.getElementById('med').textContent = "M\xE9diane:  ".concat(med);
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"getRaces.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            try {
              console.log(filter);
              url = "historical?".concat(!filter.page || filter.page === '1' ? '' : "&page=".concat(filter.page)).concat(!filter.distance || filter.distance === '1' ? '' : "&races.race.distance=".concat(filter.distance)).concat(!filter.name || filter.name === '1' ? '' : "&races.race.name=".concat(filter.name)).concat(!filter.size || filter.size === '1' ? '' : "&races.size=".concat(filter.size)).concat(!filter.season || filter.season === '1' ? '' : "&season=".concat(filter.season));
              console.log(url);
              location.assign(url);
            } catch (err) {
              (0, _alerts.showAlert)('error', err.response.data.message);
...
var _getRaces = require("./getRaces");
...
var userFilterForm = document.querySelector('.form__filter-users');
var racesFilterForm = document.querySelector('.form__filter-races');
var prevPage = document.querySelector('#prevPage');
var nextPage = document.querySelector('#nextPage');
var deleteBtn = document.querySelector('#deleteBtn');
var updateGroupForm = document.querySelectorAll('.updateGroup');
var getPersonalStatsBtn = document.querySelector('#getPersonalStats');
var getCompareStatsBtn = document.querySelector('#getCompareStatsBtn');
var studentsFilterForm = document.querySelector('#studentsFilterForm');
var searchBar = document.querySelector('#search_name');
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  var form = {
    ...
    role: document.getElementById('role') ? document.getElementById('role').value : 'not-admin'
  };
  (0, _updateSettings.updateSettings)(form, 'data');
});
if (deleteBtn) deleteBtn.addEventListener('click', function (e) {
  e.preventDefault();
  (0, _updateSettings.deleteUser)();
});
...
if (userFilterForm) {
  var btns = document.querySelectorAll('.submitFilters'); // Buttons
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                console.log(filter);
                _context2.next = 5;
                return (0, _getUsers.getUsers)(filter);
...
if (studentsFilterForm) {
  var _btns = document.querySelectorAll('.submitFilters');

  var teacher = new URL(window.location).pathname.split('/')[2].split('?')[0]; // Buttons
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                console.log(filter);
                _context4.next = 5;
                return (0, _getUsers.getStudents)(filter);
  ...
  studentsFilterForm.addEventListener('submit',
  /*#__PURE__*/
  function () {
...
if (racesFilterForm) {
  var _btns2 = document.querySelectorAll('.racesFilterBtn');

  console.log(_btns2); // Buttons
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 6;
                return (0, _getRaces.getRaces)(filter);
...
if (prevPage) {
  prevPage.addEventListener('click', function (e) {
    ...
    var parmas = new URLSearchParams(url.search);
    var page = parmas.get('page') * 1 || 1;
...
if (updateGroupForm) {
  updateGroupForm.forEach(function (updateGroup, i) {
    updateGroup.addEventListener('submit', function (e) {
      e.preventDefault();
      var group = document.querySelectorAll('.input__group')[i].value;
      var id = document.querySelectorAll('.input__group')[i].dataset.id;
      console.log(group, id);
      (0, _updateSettings.update_group)(group, id);
    });
  });
} //-------------------------------------------------------
// -- Chart
